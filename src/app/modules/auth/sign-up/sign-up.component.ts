...
export class AuthSignUpComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.signUpForm = this._formBuilder.group({
      ...
      recent_tuition_mode: ['', Validators.required],
  ...
  signUp(): void {
    ...
    const postBody = {
      ...
      mother_name: this.signUpForm.value.mother_name,
      gender: this.signUpForm.value.gender,
      dob: this.signUpForm.value.dob,
      class: this.signUpForm.value.class,
      recent_tuition_mode: this.signUpForm.value.recent_tuition_mode,
      home_address: this.signUpForm.value.home_address,
      school_name: this.signUpForm.value.school_name,
    }

    this.apiService.registrationStudent(postBody).subscribe((res: any) => {
      console.log(res);
      //todo update Object
      if (res.data) {
